...
//now we remove our initial state and use a state which will get using redux thunk
// const initialState = [
//   {
//     id: "1",
...
const postsSlice = createSlice({
  ...
  extraReducers(builder) {
    //the addCase() are listening for the promise status types that are dispatched by the fetchPosts thunk
    builder
